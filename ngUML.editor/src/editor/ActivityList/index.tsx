...
const ActivityList: React.FC<IProps>  = ({close}) => {
    ...
    const { getActivities,setActivities,activities,importData} = React.useContext(EditorData)!
    const [activity,setActivity] = React.useState<IActivity | {name:string,id:number}>({name:"",id:0})
                ...
                >
                    ...
                    <tbody>
                    {
                        ...
                        <Alert
                            ...
                            onClose={() => {setDialog(false);setActivity({name:"",id:0})}}
                            onConfirm={() => {
                                importData(activity.id,true)
                                close();
                            }}
                        >
                            You are about to load {activity.name} thereby discarding all your current progress.
                        </Alert>
                        <Alert
                            className='bp3-dark'
                            intent='warning'
