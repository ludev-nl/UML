...
interface IEditorData {
    ...
    importData: (id?:number,activity?:boolean) => void;
    getActivities: () => void;
...
export const EditorDataProvider: React.FC = ({children}) => {
    ...
    const importData = (id?:number,activity?:boolean) => {
        // GET NODES
        fetch(configuration.url+"model/data?uml-type="+(activity? 'activity' : 'class')+(id && id != 0 ?"&activity-id="+id  :''))
