...
def application_getter_function():
    return ('def __get_application(request):\n'
...
def remove_views(classifier):
    os.remove('shared/views/' + classifier.name.lower() + '.py')
...
class ClassifierGenerator(object):
    ...
    def link_application(self, application_id):
        ...
        copyfile('shared/views/' + self.classifier.name.lower() + '.py', application.name + '/views/' + self.classifier.name.lower() + '.py')
        f = open(application.name + "/views/__init__.py", "a+")
        f.write('from . import ' + self.classifier.name.lower() + '\n')
        f.close()

        urls = (
                '    path(\'' + self.classifier.name.lower() + '/\', views.' + self.classifier.name.lower() + '.index),\n'
                + '    path(\'' + self.classifier.name.lower() + '/add\', views.' + self.classifier.name.lower() + '.add),\n'
                + '    path(\'' + self.classifier.name.lower() + '/<id>\', views.' + self.classifier.name.lower() + '.edit),\n'
                + '    path(\'' + self.classifier.name.lower() + '/<id>/delete\', views.' + self.classifier.name.lower() + '.delete),\n'
        )
