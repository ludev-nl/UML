...
urlpatterns = [
    ...
    path('applications/<application_id>/addcategory', views.pages.add_category),
    path('applications/<application_id>/category/<category_id>/', views.pages.show_category),
    path('applications/<application_id>/category/<category_id>/edit', views.pages.edit_category),
    path('applications/<application_id>/category/<category_id>/delete', views.pages.delete_category),
    path('applications/<application_id>/category/<category_id>/addpage', views.pages.add_page),
